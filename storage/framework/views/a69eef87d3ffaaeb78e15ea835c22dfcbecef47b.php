<?php $__env->startSection('title','ข้อมูลพื้นที่ชุมชน'); ?>
...
<div class="col-md-12">
      ...
      <div class="box">
        <div class="box-body">
          ...
          <div class="displayproblem" id="l">ผู้ใช้ระดับพื้นที่ : <?php echo e(Auth::user()->area->name); ?></div>
...
<script type="text/javascript">
    $(function(){
      ...
      $('body').delegate('.delfile','click',function(){
        ...
        var id = $(this).data('id');
        $.ajax({
            url : '<?php echo url('operator/areauser'); ?>'+'/'+id,
            type : "POST",
            data : {
              '_method':'DELETE',
      ...
      $('select[name="taggroup_id"]').on('change', function() {
        var id = $(this).val();
        $.ajax({
            url : '<?php echo url('operator/tagdetail'); ?>',
            type : "get",
            //asyncfalse
            data : {
              '_token': '<?php echo e(csrf_token()); ?>',
      ...
      $('.uploadfile').click(function(){
        //alert('upload start');
          //var research_id = $('#research_id').val();
              $.ajax({
                  url : '<?php echo url('operator/uploadfile'); ?>',
                  async:false,
                  type:'post',
                  processData: false,
                  contentType: false,
      ...
      $('body').delegate('.edit','click',function(){
        ...
        //alert(id);
        $.ajax({
            url : '<?php echo url('operator/areauser'); ?>'+'/'+id+'/edit',
            type : "get",
            //asyncfalse
            data : {
              '_token': '<?php echo e(csrf_token()); ?>'
      ...
      $('body').delegate('.deleteprobm','click',function(){
        ...
        $('#taggroupdetail').html('');
        $.ajax({
            url : '<?php echo url('operator/problem'); ?>'+'/'+idp,
            type : "POST",
            //asyncfalse
            data : {
              '_method':'DELETE',
      ...
      $('body').delegate('.report','click',function(){
        ...
        //alert(ida);
        $.ajax({
            url : '<?php echo url('operator/areauser'); ?>'+'/'+ida,
            type : "get",
            //asyncfalse
            data : {
              '_token': '<?php echo e(csrf_token()); ?>'
  ...
  $('body').delegate('.editprobm','click',function(){
    ...
    //alert(idp);
    $.ajax({
        url : '<?php echo url('operator/problem'); ?>'+'/'+idp+'/edit',
        type : "get",
        //asyncfalse
        data : {
          '_token': '<?php echo e(csrf_token()); ?>'
    ...
    $('.saverecordprobm').click(function(){
        var area_id = $('#area_id').val();
            $.ajax({
                url : '<?php echo url('operator/problem'); ?>',
                async:false,
                type:'post',
                processData: false,
                contentType: false,
    ...
    function displaydata(){
      //alert(0);
      $.ajax({
        url : '<?php echo url('operator/areauser/create'); ?>',
        type : "get",
        //asyncfalse
        data : {},
        success : function(s)
    ...
    function displayprobm(id){
        //alert(id);
        $.ajax({
          //url : '<?php echo url('operator/research/create'); ?>',
          url : '<?php echo url('operator/problem'); ?>',
          type : "get",
          //asyncfalse
          data : {
