...
<?php $__env->startSection('subtitle','รายละเอียดระบบ'); ?>
                ...
                <p>&emsp;&emsp;&emsp;ระบบฐานข้อมูลการวิจัยและพัฒนาชุมชนท้องถิ่นน่าอยู่สำหรับเครือข่ายมหาวิทยาลัยราชภัฏ
                  ...
                  โดยพัฒนาชุดความรู้ คู่มือ องค์ความรู้และนวัตกรรม เครื่องมือทางวิชาการที่ชุมชนท้องถิ่นสามารถนำใช้ในการต่อยอดขยายผลสู่การจัดการตนเองอย่างยั่งยืน</p>
                    ...
                    <p>&emsp;&emsp;&emsp;การพัฒนาระบบศูนย์กลางสำหรับการจัดการข้อมูลทั้งระบบจึงมีบทบาทและความจำเป็น
                      ...
                      <p><i class='fa fa-paperclip'></i><a href="<?php echo e(url('/usermanual.pdf')); ?>">คู่มือการใช้ระบบ</a></p>
          </div>
          <!-- /.comment-text -->
        </div>
        <!-- /.box-comment -->
...
<div class="row">
  <div class="col-md-6">
    <div class="box box-widget">
        <!-- /.box-header -->
        <div class="box-body">
          <a href="<?php echo e(url('images/system/1.png')); ?>" data-toggle="lightbox" data-gallery="example-gallery">
          <img class="img-responsive pad" src="<?php echo e(url('images/system/1.png')); ?>">
        </a>
        </div>
        <!-- /.box-body -->
        <div class="box-footer box-comments">
      ...
      <div class="box box-widget">
          <div class="box-body">
            <a href="<?php echo e(url('images/system/3.png')); ?>" data-toggle="lightbox" data-gallery="example-gallery">
            <img class="img-responsive pad" src="<?php echo e(url('images/system/3.png')); ?>">
          </a>
          </div>
          <!-- /.box-body -->
          <div class="box-footer box-comments">
  ...
  <div class="col-md-6">
    <div class="box box-widget">
        <div class="box-body">
          <a href="<?php echo e(url('images/system/2.png')); ?>" data-toggle="lightbox" data-gallery="example-gallery">
          <img class="img-responsive pad" src="<?php echo e(url('images/system/2.png')); ?>">
        </a>
        </div>
        <!-- /.box-body -->
        <div class="box-footer box-comments">
      ...
      <div class="box box-widget">
          <div class="box-body">
            <a href="<?php echo e(url('images/system/4.png')); ?>" data-toggle="lightbox" data-gallery="example-gallery">
            <img class="img-responsive pad" src="<?php echo e(url('images/system/4.png')); ?>">
          </a>
          </div>
          <!-- /.box-body -->
          <div class="box-footer box-comments">
