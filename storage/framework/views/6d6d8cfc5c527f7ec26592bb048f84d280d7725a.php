<?php $__env->startSection('title','สำรองไฟล์ในระบบ'); ?>
<?php $__env->startSection('subtitle','สร้างไฟล์สำรองข้อมูล'); ?>
       ...
       <div class="col-md-12">
          <div class="box box-primary">
            ...
            <div class="box">
              <!-- /.box-header -->
              <div class="box-body">
                <a href="<?php echo e(url('mnt/bkfilenow')); ?>" type="button" class="btn btn-primary btndetail">สำรองข้อมูล</a><br><br>
...
?>
            <form action="<?php echo e(url('mnt/deletefile')); ?>" method="post">
