<?php $__env->startSection('title','ข้อมูลการสื่อสาร'); ?>
<?php $__env->startSection('subtitle','จัดการข้อมูลการสื่อสาร'); ?>
...
<div class="col-md-12">
          ...
          <form role="form" id="form_data" name="form_data">
            <div class="box-body">
              ...
              <div class="form-group">
                <label>ผู้ส่ง : <?php echo e(Auth::user()->headname); ?><?php echo e(Auth::user()->firstname); ?> <?php echo e(Auth::user()->lastname); ?>(<?php echo e(Auth::user()->email); ?>)</label>
              </div>
              <div class="form-group">
              ...
              <input type="hidden" name="sender" id="sender" value="<?php echo e(Auth::user()->headname); ?><?php echo e(Auth::user()->firstname); ?> <?php echo e(Auth::user()->lastname); ?>">
              <input type="hidden" name="tel" id="tel" value="<?php echo e(Auth::user()->tel); ?>">
              <input type="hidden" name="address" id="address" value="<?php echo e(Auth::user()->address); ?>">
...
<script type="text/javascript">
    $(function(){
      ...
      $('body').delegate('.delete','click',function(){
        ...
        $('.showreport').hide();
        $.ajax({
            url : '<?php echo url('user/question'); ?>'+'/'+id,
            type : "POST",
            data : {
              '_method':'DELETE',
  ...
  $('.saverecord').click(function(){
    $("#loading").show();
      ...
      function savedata(){
            $.ajax({
                url : '<?php echo url('user/question'); ?>',
                type : "post",
                data : $('form#form_data').serialize(),
                success:function(re)
                {
    ...
    function displaydata(){
      //alert(0);
      $.ajax({
        url : '<?php echo url('user/question/create'); ?>',
        type : "get",
        data : {},
        success : function(s)
        {
    ...
    function getresearcher(){
      //alert(0);
      $.ajax({
        url : '<?php echo url('user/question/getresearcher'); ?>',
        type : "post",
        data : $('form#form_data').serialize(),
        success : function(s)
        {
