...
<?php $__env->startSection('subtitle','แสดงข้อมูล'); ?>
          ...
          <div class="box box-primary">
            ...
            <div class="box-body no-padding">
              <div class="mailbox-read-info">
                ...
                <h5>From: <?php echo e($data->user->firstname); ?>

                  <span class="mailbox-read-time pull-right"><i class="fa fa-clock-o"></i><?php echo e($data->updated_at); ?></span></h5>
              </div>
              <!-- /.mailbox-controls -->
