...
<div class="col-md-12">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">พื้นที่ชุมชน : <?php echo e(Auth::user()->university->name); ?></h3>
            </div>
            <!-- /.box-header -->
              ...
              <div class="box-body">
                ...
                <div class="form-group" id="j">
                  ...
                  <select name="center_id" id="center_id" class="form-control" style="width:350px">
                    ...
                    <?php foreach($objcenter as $key => $value): ?>
...
<script type="text/javascript">
    $(function(){
      ...
      $('body').delegate('.edit','click',function(){
        ...
        //alert(0);
        $.ajax({
            url : '<?php echo url('univer/area'); ?>'+'/'+id+'/edit',
            type : "get",
            //asyncfalse
            data : {
      ...
      $('body').delegate('.delete','click',function(){
        ...
        $('#msgname').html('');
        $.ajax({
            url : '<?php echo url('univer/area'); ?>'+'/'+id,
            type : "POST",
            //asyncfalse
            data : {
              '_method':'DELETE',
    ...
    function displaydata(){
      $.ajax({
        url : '<?php echo url('univer/area/create'); ?>',
        type : "get",
        //asyncfalse
        data : {},
        success : function(s)
