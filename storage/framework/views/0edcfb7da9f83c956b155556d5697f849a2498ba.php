  ...
  <div id='showgraph1'>
      <div class="box box-primary">
          <div class="box-header with-border">
            <h3 class="box-title">งานวิจัยทั้งหมด ( <?php echo e(count($objres)); ?> เรื่อง )</h3>
          </div>
...
<script type="text/javascript">
  ...
  function displayresearch(id){
      $.ajax({
        url : '<?php echo url('eis/research/showresearch'); ?>',
        type : "get",
        //asyncfalse
        data : {
          'id' : id,
...
function displaygroup(id){
    $.ajax({
      url : '<?php echo url('eis/research/showgroup'); ?>',
      type : "get",
      //asyncfalse
      data : {
        'id' : id,
...
function displaydoc(id){
    $.ajax({
      url : '<?php echo url('eis/research/showdoc'); ?>',
      type : "get",
      //asyncfalse
      data : {
        'id' : id,
