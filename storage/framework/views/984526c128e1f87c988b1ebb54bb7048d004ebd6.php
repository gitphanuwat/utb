<?php $__env->startSection('title','ระบบสนับสนุนโจทย์วิจัย'); ?>
<?php $__env->startSection('subtitle','ค้นหาข้อมูล'); ?>
  ...
  <div id='showgraph2'>
    <div class="box box-primary">
        ...
        <div class="box-body with-border">
          <div class="row">
            <div class="col-lg-12">
                  <form action="<?php echo e(url('dss/topic')); ?>" method="POST" class="navbar-form pull-left" role="search">
                      <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>" />
                      <i class="fa fa-bar-chart-o"></i>
                      <div class="form-group">
                          <div class="input-group">
                              <input type="text" name="search" value="<?php echo e(isset($search) ? $search : null); ?>" placeholder="คำค้น (จากหัวข้อหรือคำถามงานวิจัย)" class="form-control" size="60" />
