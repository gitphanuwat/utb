        ...
        <div class="col-md-12">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">ข้อมูลศูนย์จัดการเครือข่าย : <?php echo e(Auth::user()->university->name); ?></h3>
            </div>
            <!-- /.box-header -->
...
<script type="text/javascript">
    $(function(){
      ...
      $('body').delegate('.edit','click',function(){
        ...
        //alert(0);
        $.ajax({
            url : '<?php echo url('univer/center'); ?>'+'/'+id+'/edit',
            type : "get",
            //asyncfalse
            data : {
      ...
      $('body').delegate('.delete','click',function(){
        ...
        $('.btndetail').show();
        $.ajax({
            url : '<?php echo url('univer/center'); ?>'+'/'+id,
            type : "POST",
            //asyncfalse
            data : {
              '_method':'DELETE',
      ...
      $('.saverecord').click(function(){
          ...
          var address = $('#address').val();
              $.ajax({
                  url : '<?php echo url('univer/center'); ?>',
                  type : "POST",
                  data : {
                    '_token': '<?php echo e(csrf_token()); ?>',
                    'name' : name,
    ...
    function displaydata(){
      //alert(0);
      $.ajax({
        url : '<?php echo url('univer/center/create'); ?>',
        type : "get",
        //asyncfalse
        data : {},
        success : function(s)
