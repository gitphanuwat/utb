<?php $__env->startSection('title','ปัญหาชุมชน'); ?>
...
function displayexp(id){
      $.ajax({
        url : '<?php echo url('eis/problem/showexp'); ?>',
        type : "get",
        //asyncfalse
        data : {
          'id' : id,
...
function displaypro(id){
      $.ajax({
        url : '<?php echo url('eis/problem/showpro'); ?>',
        type : "get",
        //asyncfalse
        data : {
          'id' : id,
...
function displaygroup(id){
    //alert(0);
    $.ajax({
      url : '<?php echo url('eis/problem/showgroup'); ?>',
      type : "get",
      //asyncfalse
      data : {
        'id' : id,
...
function displayproblem(id){
    $.ajax({
      url : '<?php echo url('eis/problem/showproblem'); ?>',
      type : "get",
      //asyncfalse
      data : {
        'id' : id,
