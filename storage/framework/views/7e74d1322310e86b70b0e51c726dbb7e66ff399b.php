...
<link rel="stylesheet" href="<?php echo e(asset("assets/test/bootstrap-tagsinput.css")); ?>">
<link rel="stylesheet" href="<?php echo e(asset("assets/test/app.css")); ?>">
...
<script type="text/javascript">
    $(function(){
      ...
      $('body').delegate('.edit','click',function(){
        ...
        var id = $(this).data('id');
        $.ajax({
            url : '<?php echo url('user/research'); ?>'+'/'+id+'/edit',
            type : "get",
            //asyncfalse
            data : {
              '_token': '<?php echo e(csrf_token()); ?>'
            ...
            success : function(e)
            {
              ...
              var con = new Array();
                ...
                for (a in con) {
                  ...
                  if($.isNumeric(idr)){
                  $.ajax({
                      url : '<?php echo url('eis/researcher/name'); ?>'+'/'+idr,
                      type : "get",
                      success : function(e)
                      {
                        //alert(e.id);
              ...
              if(texp!=''){
                ...
                for (a in exp) {
                  ...
                  if($.isNumeric(ide)){
                  $.ajax({
                      url : '<?php echo url('eis/expert/name'); ?>'+'/'+ide,
                      type : "get",
                      success : function(e)
                      {
      ...
      $('body').delegate('.delete','click',function(){
        ...
        $('#keyword').tagsinput();
        $.ajax({
            url : '<?php echo url('user/research'); ?>'+'/'+id,
            type : "POST",
            //asyncfalse
            data : {
              '_method':'DELETE',
      ...
      $('.saverecord').click(function(){
          ...
          //$('#new_group').val('error');
            //alert(researcher_id);
              $.ajax({
                  url : '<?php echo url('user/research'); ?>',
                  type : "POST",
                  data : {
                    '_token': '<?php echo e(csrf_token()); ?>',
    ...
    function displaydata(){
      //alert(0);
      $.ajax({
        url : '<?php echo url('user/research/create'); ?>',
        type : "get",
        //asyncfalse
        data : {},
        success : function(s)
...
<script src="<?php echo e(asset("assets/test/bootstrap-tagsinput.min.js")); ?>"></script>
<script type="text/javascript">
