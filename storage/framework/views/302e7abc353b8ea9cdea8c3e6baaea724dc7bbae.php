        ...
        <div class="box-body">
          ...
          <div class="showdetailprobm">
            ...
            <label>ข้อมูลปัญหาชุมชน</label>
                ...
                <div class="form-group" id="lgr">
                  <label>สถานะของปัญหา</label>
                  <select name="status" id="status" class="form-control" style="width:350px">
...
<script type="text/javascript">
    $(function(){
      ...
      $('body').delegate('.delfile','click',function(){
        ...
        var id = $(this).data('id');
        $.ajax({
            url : '<?php echo url('user/areauser'); ?>'+'/'+id,
            type : "POST",
            data : {
              '_method':'DELETE',
      ...
      $('.uploadfile').click(function(){
        //alert('upload start');
          //var research_id = $('#research_id').val();
              $.ajax({
                  url : '<?php echo url('user/uploadfile'); ?>',
                  async:false,
                  type:'post',
                  processData: false,
                  contentType: false,
      ...
      $('body').delegate('.edit','click',function(){
        ...
        //alert(id);
        $.ajax({
            url : '<?php echo url('user/areauser'); ?>'+'/'+id+'/edit',
            type : "get",
            //asyncfalse
            data : {
              '_token': '<?php echo e(csrf_token()); ?>'
      ...
      $('body').delegate('.deleteprobm','click',function(){
        ...
        $('#taggroupdetail').html('');
        $.ajax({
            url : '<?php echo url('user/problem'); ?>'+'/'+idp,
            type : "POST",
            //asyncfalse
            data : {
              '_method':'DELETE',
      ...
      $('body').delegate('.report','click',function(){
        ...
        //alert(ida);
        $.ajax({
            url : '<?php echo url('user/areauser'); ?>'+'/'+ida,
            type : "get",
            //asyncfalse
            data : {
              '_token': '<?php echo e(csrf_token()); ?>'
  ...
  $('body').delegate('.editprobm','click',function(){
    ...
    //alert(idp);
    $.ajax({
        url : '<?php echo url('user/problem'); ?>'+'/'+idp+'/edit',
        type : "get",
        //asyncfalse
        data : {
          '_token': '<?php echo e(csrf_token()); ?>'
    ...
    function displaydata(){
      //alert(0);
      $.ajax({
        url : '<?php echo url('user/areauser/create'); ?>',
        type : "get",
        //asyncfalse
        data : {},
        success : function(s)
