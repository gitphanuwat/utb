  ...
  <div class="box box-primary">
    ...
    <div class="box">
      ...
      <div id="tri" class="btn-group btn-group-sm">
        <a href="<?php echo url('operatorset/member'); ?>" type="button" name="total" class="btn btn-default <?php echo e(classActiveOnlyPath('operatorset/member')); ?>">ทั้งหมด
  	...
  	<div class="table-responsive">
          ...
          <?php foreach($users as $user): ?>
        		<tr <?php echo !$user->seen? 'class="warning"' : ''; ?>>
        			...
        			<td>
                <a href="<?php echo e(url("operatorset/member/".$user->id)); ?>" class="btn btn-success"> รายละเอียด </a>
        			</td>
        			<td>
        				<a href="<?php echo e(url("operatorset/member/".$user->id."/edit")); ?>" class="btn btn-warning"> แก้ไข </a>
        			</td>
        			<td>
        				<form action="<?php echo e(url('operatorset/member/'.$user->id)); ?>" method="post" onsubmit="return(confirm('ลบข้อมูล'))">
    ...
    <div class="box">
      ...
      <a href="<?php echo e(url("operatorset/member/create")); ?>" class="btn btn-primary pull-left"> เพิ่มสมาชิก </a>
  ...
  <script>
    ...
    $(function() {
      $('body').delegate('.btndetail','click',function(){
          ...
          $('#showdetail').html('ttt');
          $.ajax({
              url : '<?php echo url('operatorset/member'); ?>'+'/'+id,
              type : "GET",
              //asyncfalse
              data : {
      ...
      $(document).on('change', ':checkbox', function() {
        ...
        $.ajax({
          url: '<?php echo url('operatorset/member/userseen'); ?>' + '/' + this.value,
          type: 'PUT',
