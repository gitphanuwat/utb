...
<section class="sidebar">
  ...
  <div class="user-panel">
    ...
    <a href="#"><i class="fa fa-circle text-success"></i> ระดับ : <?php echo e(Auth::user()->role->title); ?><br>
...
<?php if(Auth::user()): ?>
    ...
    <?php endif; ?>
      ...
      <li <?php echo classActivePath('user/useful'); ?>>
        <a href="<?php echo e(url ('user/useful')); ?>">
          <i class="fa fa-calendar"></i> <span>การใช้ประโยชน์</span>
          <span class="pull-right-container">
...
<?php endif; ?>
    ...
    <li class="treeview <?php echo e(classActiveOnlySegment(1,'about')); ?>">
      ...
      <ul class="treeview-menu">
        ...
        <li <?php echo classActivePath('about/update'); ?>><a href="<?php echo e(url('about/update')); ?>"><i class="fa fa-circle-o"></i> การอัพเดทระบบ</a></li>
      </ul>
    </li>
