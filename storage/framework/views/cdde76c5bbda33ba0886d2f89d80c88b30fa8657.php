<?php $__env->startSection('title','ข้อมูลปัญหาในพื้นที่ชุมชน'); ?>
<?php $__env->startSection('subtitle','ส่งหัวข้อปัญหา'); ?>
            ...
            <form role="form" id="form_data" name="form_data">
              <div class="box-body">
                ...
                <div class="form-group">
                  <label>หัวข้อ</label>
                  <input type="text" class="form-control" name="topic" id="topic"  placeholder="หัวข้อปัญหา" value="<?php echo e(session()->get('sess_search')); ?>">
                </div>
                <div class="form-group">
...
<script type="text/javascript">
    ...
    $('.saverecord').click(function(){
      $("#loading").show();
            $.ajax({
                url : '<?php echo url('question/sendquest'); ?>',
                type : "post",
            ...
            $.ajax({
                ...
                success:function(re)
                {
                  ...
                  if(re == 0){
                    //displaydata();
                    $("#loading").fadeOut();
                    $( '#msgname' ).html('<div class="alert alert-success">ส่งข้อความสำเร็จ</div>');
    ...
    function displaydata(){
      //alert(0);
      $.ajax({
        url : '<?php echo url('question/showresearcher'); ?>',
        type : "get",
        data : {},
        success : function(s)
        {
