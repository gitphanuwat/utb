...
class AreaUserController extends Controller
{
    ...
    public function index()
    {
          ...
          return view('operator.areauser',compact('objtag'));
    }
    ...
    public function create()
    {
        ...
        $data = Area::where('id',$id)->orderby('name')->get();
      $display="
    ...
    {
        $areobj = Area::find($id);
        if(Auth::user()->area_id == $areobj->id){
    ...
    public function destroy($id)
    {
        ...
        //$data = Area::find($areafile->area_id);
            if(Auth::user()->area_id == $areafile->area_id){
              //$areafile = Areafile::find($id);
              $data = Area::find($areafile->area_id);
