...
@section('title','ข้อมูลผู้เชี่ยวชาญ')
    ...
    <div class="col-md-12">
      ...
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="profile-username text-left">ผู้เชี่ยวชาญ</h3>
          <p class="text-muted text-left">{{ $objexptor->headname.$objexptor->firstname." ".$objexptor->lastname}}</p>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
