...
<script type="text/javascript">
    ...
    function displayexp(id){
        $.ajax({
          url : '{!! url('eis/researcher/showexpert') !!}',
          type : "get",
          //asyncfalse
          data : {
            'id' : id,
  ...
  function displayresearch(id){
      $.ajax({
        url : '{!! url('eis/researcher/showresearch') !!}',
        type : "get",
        //asyncfalse
        data : {
          'id' : id,
...
function displaycre(id){
    $.ajax({
      url : '{!! url('eis/researcher/showcreative') !!}',
      type : "get",
      //asyncfalse
      data : {
        'id' : id,
...
function displaygroup(id){
    //alert(0);
    $.ajax({
      url : '{!! url('eis/researcher/showgroup') !!}',
      type : "get",
      //asyncfalse
      data : {
        'id' : id,
...
function displayresearcher(id){
    $.ajax({
      url : '{!! url('eis/researcher/showresearcher') !!}',
      type : "get",
      //asyncfalse
      data : {
        'id' : id,
