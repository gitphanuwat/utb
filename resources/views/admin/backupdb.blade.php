...
@section('title','สำรองฐานข้อมูล')
@section('subtitle','สร้างไฟล์สำรองฐานข้อมูล')
@section('body')
<div class="row">
      <div class="col-md-12">
          <div class="box box-primary">
            ...
            <div class="box">
              <!-- /.box-header -->
              <div class="box-body">
                <a href="{{url('mnt/bkdbnow')}}" type="button" class="btn btn-primary btndetail">สำรองฐานข้อมูล</a><br><br>
...
?>
            <form action="{{ url('mnt/deletedb') }}" method="post">
