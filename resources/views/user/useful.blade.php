                ...
                <div class="form-group">
                  ...
                  <select name="area_id" id="area_id" class="form-control select2" style="width:350px">
                      ...
                      @foreach ($objare as $key)
                          <option value="{{ $key->id }}">{{ $key->name }} (ศจค.{{ $key->center->name }})</option>
                      @endforeach
                  </select>
                </div>
                <div class="form-group">
