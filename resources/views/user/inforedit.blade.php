...
<div class="col-md-12">
          ...
          <form action="{{url('user/infor/'.$data->id)}}" id="form_data" name="form_data" role="form" method="POST">
            {{ method_field('PUT') }}
                <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <textarea class="textarea" id="detail" name="detail" placeholder="รายละเอียด" style="width: 100%; height: 225px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{!! $data->detail !!}</textarea>
                </div>
                </div>
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="keyman" id="keyman" value="{{ Auth::user()->firstname}} {{ Auth::user()->lastname}}" disabled="true">
                </div>
                </div>

                <input type="hidden" name="user_id" id="user_id" value="{{ Auth::user()->id}}">
                <input type="hidden"  id="id" value="{{$data->id}}">
                <input type="hidden" class="form-control" name="file_id" id="file_id" value="{{$data->file_id}}">
          ...
          <div class="panel panel-info">
            ...
            <div class="panel-body">
              <form enctype="multipart/form-data" class="dropzone" action="{{url('user/upload')}}" method="post" id="real-dropzone">
