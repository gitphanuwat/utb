...
<div class="col-md-12">
          ...
          <form action="{{url('user/infor')}}" id="form_data" name="form_data" role="form" method="POST">
                <div class="form-group">
                ...
                <input type="hidden" class="form-control" name="file_id" id="file_id" value="{{ Auth::user()->id}}_{{ time() }}">
...
{!! HTML::script('/assets/js/dropzone-config1.js') !!}
