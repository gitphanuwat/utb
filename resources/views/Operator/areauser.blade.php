...
<div class="col-md-12">
      ...
      <div class="box">
        <div class="box-body">
          ...
          <div class="displayproblem" id="l">ผู้ใช้ระดับพื้นที่ : {{ Auth::user()->area->name }}</div>
...
<script type="text/javascript">
    $(function(){
      ...
      $('body').delegate('.edit','click',function(){
        ...
        //alert(id);
        $.ajax({
            url : '{!! url('operator/areauser') !!}'+'/'+id+'/edit',
            type : "get",
            //asyncfalse
            data : {
              '_token': '{{ csrf_token() }}'
  ...
  $('body').delegate('.editprobm','click',function(){
    ...
    //alert(idp);
    $.ajax({
        url : '{!! url('operator/problem') !!}'+'/'+idp+'/edit',
        type : "get",
        //asyncfalse
        data : {
          '_token': '{{ csrf_token() }}'
    ...
    function displaydata(){
      //alert(0);
      $.ajax({
        url : '{!! url('operator/areauser/create') !!}',
        type : "get",
        //asyncfalse
        data : {},
        success : function(s)
    ...
    function displayprobm(id){
        //alert(id);
        $.ajax({
          //url : '{!! url('operator/research/create') !!}',
          url : '{!! url('operator/problem') !!}',
          type : "get",
          //asyncfalse
          data : {
